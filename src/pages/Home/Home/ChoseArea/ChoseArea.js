...
const ChoseArea = () => {
   return (
      <section className="tp-choose-area position-relative pt-80 pb-80 premium-home__process">
            ...
            <div className="row justify-content-between align-items-center premium-home__process-layout">
               <div className="col-xl-5 col-lg-6">
                  <div className="tp-choose-img mb-30 z-index wow fadeInUp premium-home__process-media" data-wow-delay=".3s">
                     <img src="assets/img/about/choose-img-1.jpg" loading="lazy" alt="DeepCleanz cleaning team preparing for a home cleaning service" />
                  </div>
               </div>
