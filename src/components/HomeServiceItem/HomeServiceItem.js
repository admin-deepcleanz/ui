...
const HomeServiceItem = ({ icon_name, title, content, className = '' }) => {
   return (
      <>
         <div className={`col-xl-3 col-md-6 ${className}`.trim()}>
            <div className="tp-services white-bg wow fadeInUp premium-home__service-card" data-wow-delay=".2s">
               ...
               <div className="tp-services-text fix premium-home__service-body">
                  ...
                  <div className="tp-services-text-link premium-home__service-link">
                     <Link to="/servicesDetails"><i className="flaticon-enter"></i> View Service</Link>
                  </div>
               </div>
            </div>
         </div>
