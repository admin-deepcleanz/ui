                        ...
                        <div className="row mb-10">
                              ...
                              <div className="tp-about-service mb-30">
                                 ...
                                 <div className="tp-about-service-text">
                                    <h4 className="tp-about-service-text-title mb-15 hover-theme-color">
                                       <Link to="/services">Residential Cleaning Services</Link>
                                    </h4>
                                    <p>
                                       From living rooms to bedrooms, bathrooms to kitchens - we cover every corner of
                                       your home. Our trained professionals use safe, high-quality products to leave
                                       your space spotless, sanitized, and stress-free.
                                    </p>
                                 </div>
                              </div>
                           </div>
                           <div className="col-sm-6">
                              <div className="tp-about-service mb-30">
                                 ...
                                 <div className="tp-about-service-text">
                                    <h4 className="tp-about-service-text-title mb-15 hover-theme-color">
                                       <Link to="/services">Commercial Cleaning Services</Link>
                                    </h4>
                                    <p>
                                       We help businesses maintain a clean and productive environment. From office spaces
                                       to storefronts, our commercial cleaning solutions ensure a fresh, professional
                                       setting that leaves the right impression.
                                    </p>
                                 </div>
                              </div>
                           </div>
